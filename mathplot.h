...
//     wxCoord y2p(double y, bool drawOutside = true); // { return (wxCoord) ( (m_posY-y) * m_scaleY); }
    ...
    */
    ...
    /** Set view to fit global bounding box of all plot layers and refresh display.
        ...
        The X/Y scale aspect phyLock is taken into account.
    */
    void Fit();
...
protected:
    ...
    /** These are updated in Fit() only, and may be different from the real borders (layer coordinates) only if phyLock aspect ratio is true.
      */
